...
import NumeralFormatter from './shortcuts/NumeralFormatter';
import DateFormatter from './shortcuts/DateFormatter';
import TimeFormatter from './shortcuts/TimeFormatter';
import PhoneFormatter from './shortcuts/PhoneFormatter';
import CreditCardDetector from './shortcuts/CreditCardDetector';
import Util from './utils/Util';
import DefaultProperties from './common/DefaultProperties';

export default class CleaveReact extends Component {
  constructor(props) {
    super(props);
    var owner = this,
      {
  ...
  componentDidUpdate() {
    ...
    if (newValue !== undefined) {
      ...
      if (
        ...
        newValue !== owner.properties.result
      ) {
